...
public:
  ...
  void loop() { // Called once per arduino loop
    ...
    //Warning lights
    opSend(0x168, dwtemp, tyrepressure, battery, warnLightd, 0x00, 0x24, 0x00, 0x00);
    ...
    //important for STOP and (!) lights
    opSend(0x0E6, 0x00, 0x00, 0x00, 0x00, 0x00, 0x71, 0x8E, 0x1D); //Wheels rotation, voltage
    opSend(0x3A3, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00);
    opSend(0x350, 0x00, 0x00, 0x00, 0x09, 0x08, 0x40, 0x04, 0x00); //FMUX
    opSend(0x1A0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00); //CD changer status
    opSend(0x53D, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
    opSend(0x0E6, 0x00, 0x00, 0x00, 0x00, 0x00, 0x71, 0x8E, 0x4A); //Wheels rotation, voltage
    opSend(0x0E6, 0x00, 0x00, 0x00, 0x00, 0x00, 0x71, 0x8E, 0x1D); //Wheels rotation, voltage
    opSend(0x3A3, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00);
    opSend(0x350, 0x00, 0x00, 0x00, 0x09, 0x08, 0x40, 0x04, 0x00); //FMUX
    opSend(0x1A0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00); //CD changer status
