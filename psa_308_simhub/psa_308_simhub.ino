...
#define DEVICE_NAME "Peugeot 308 T9 Cluster" //{"Group":"General","Name":"DEVICE_NAME","Title":"Device name,\r\n make sure to use a unique name when using multiple arduinos","DefaultValue":"SimHub Dash","Type":"string","Template":"#define DEVICE_NAME \"{0}\""}
#define DEVICE_UNIQUE_ID "7cb5f572-36ac-4f9e-b856-580978e65a9d" //{"UniqueId":"7cb5f572-36ac-4f9e-b856-580978e65a9d","Name":"DEVICE_UNIQUE_ID","Type":"uniqueid"}
